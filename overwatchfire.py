    ...
    def overwatch_fire(marine, gs):
        if (marine["overwatch"] == True):
            ...
            if (marine["weapon loadout"] == weapons.weapon_loadout[0] or marine["weapon loadout"] == weapons.weapon_loadout[1] or marine["weapon loadout"] == weapons.weapon_loadout[4] or marine["weapon loadout"] == weapons.weapon_loadout[5] or marine["weapon loadout"] == weapons.weapon_loadout[8] or marine["weapon loadout"] == weapons.weapon_loadout[9]):
                if ((OverwatchFire.roll_1 == 5 or OverwatchFire.roll_1 == 6) and (OverwatchFire.roll_2 == 5 or OverwatchFire.roll_2 == 6)):
                    print("Genestealer has been hit!")
                    gs["alive"] = False
                    if (OverwatchFire.roll_1 == OverwatchFire.roll_2):
                ...
                if ((OverwatchFire.roll_1 == 4 or OverwatchFire.roll_1 == 5 or OverwatchFire.roll_1 == 6) and (OverwatchFire.roll_2 == 4 or OverwatchFire.roll_2 == 5 or OverwatchFire.roll_2 == 6) and (OverwatchFire.roll_3 == 4 or OverwatchFire.roll_3 == 5 or OverwatchFire.roll_3 == 6)):
                    marine["clip_size"] -= 1
                    print("Genestealer has been hit!")
                    gs["alive"] = False
                    if (OverwatchFire.roll_1 == OverwatchFire.roll_2 == OverwatchFire.roll_3):
                        marine["clip_size"] -= 1
                                    ...
                                    if (squad.squad[d]["direction"] == "north"):
                                        ...
                                        for e in range(b, gs_index, 1):
                                            if (linesight.line_of_sight[a][e] == gs["current location"]):
                                                OverwatchFire.overwatch_fire(squad.squad[d], gs)
