...
class GenestealerMove():
    def genestealer_movement():
        for x in radarblips.RadarBlips.blips: #looping through radar blips
            c1 = 0
            c2 = 0
            c3 = 0
            c4 = 0
            ...
            if (radarblips.RadarBlips.blips[x]["current location"]):
                print(squad)
                for y in squad.squad:
                    if (squad.squad[y]["current_place"]):
                        for z in linesight.line_of_sight:
                            for a in linesight.line_of_sight[z]:
                                if (radarblips.RadarBlips.blips[x]["current location"] == linesight.line_of_sight[z][a]):
                                    tracker1 == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][0]
                                    if (gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][1]):
                                        tracker2 == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][1]
                                    if (gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][2]):
                                        tracker3 == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][2]
                                    if (gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][3]):
                                        tracker4 == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][3]                                    
                                    ...
                                    if (tracker1 == squad[y]["current_place"]):
                                        if (gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"]["connected to"][0])["occupied"] != True):
                                            radarblips.RadarBlips.check_for_reveal(radarblips.RadarBlips.blips[x])
                                            radarblips.RadarBlips.blips[x]["current location"] = gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][0]
                                            radarblips.RadarBlips.blips[x]["action points"] -= 1
                                        else:
                                            for b in radarblips.RadarBlips.blips:
                                                if (radarblips.RadarBlips.blips[b] != radarblips.RadarBlips.blips[x]):
                                                    if (radarblips.RadarBlips.blips[b]["current location"] == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][0]):
                                                        break
                                                
                                            for c in genestealers:
                                                if (genestealers[c]["current location"] == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][0]):
                                                    break
                                        ...
                                        if (gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"]["connected to"][1])["occupied"] != True):
                                            radarblips.RadarBlips.check_for_reveal(radarblips.RadarBlips.blips[x])
                                            radarblips.RadarBlips.blips[x]["current location"] = gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][1]
                                            radarblips.RadarBlips.blips[x]["action points"] -= 1
                                        else:
                                            for b in radarblips.RadarBlips.blips:
                                                if (radarblips.RadarBlips.blips[b] != radarblips.RadarBlips.blips[x]):
                                                    if (radarblips.RadarBlips.blips[b]["current location"] == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][1]):
                                                        break
                                                
                                            for c in genestealers:
                                                if (genestealers[c]["current location"] == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][1]):
                                                    break
                                        ...
                                        if (gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"]["connected to"][2])["occupied"] != True):
                                            radarblips.RadarBlips.check_for_reveal(radarblips.RadarBlips.blips[x])
                                            radarblips.RadarBlips.blips[x]["current location"] = gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][2]
                                            radarblips.RadarBlips.blips[x]["action points"] -= 1
                                        else:
                                            for b in radarblips.RadarBlips.blips:
                                                if (radarblips.RadarBlips.blips[b] != radarblips.RadarBlips.blips[x]):
                                                    if (radarblips.RadarBlips.blips[b]["current location"] == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][2]):
                                                        break
                                                
                                            for c in genestealers:
                                                if (genestealers[c]["current location"] == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][2]):
                                                    break
                                        ...
                                        if (gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"]["connected to"][3])["occupied"] != True):
                                            radarblips.RadarBlips.check_for_reveal(radarblips.RadarBlips.blips[x])
                                            radarblips.RadarBlips.blips[x]["current location"] = gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][3]
                                            radarblips.RadarBlips.blips[x]["action points"] -= 1
                                        else:
                                            for b in radarblips.RadarBlips.blips:
                                                if (radarblips.RadarBlips.blips[b] != radarblips.RadarBlips.blips[x]):
                                                    if (radarblips.RadarBlips.blips[b]["current location"] == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][3]):
                                                        break
                                                
                                            for c in genestealers:
                                                if (genestealers[c]["current location"] == gametiles.tiles(radarblips.RadarBlips.blips[x]["current location"])["connected to"][3]):
                                                    break
        ...
        if len(genestealers.genestealers) > 0:
                            ...
                            for g in linesight.line_of_sight:
                                for h in linesight.line_of_sight[g]:
                                    if (genestealers[e]["current location"] == linesight.line_of_sight[g][h]):
                                        tracker1 = gametiles.tiles(genestealers[e]["current location"])[
                                            "connected to"][0]
                                        if (gametiles.tiles(genestealers[e]["current location"])["connected to"][1]):
                                            tracker2 = gametiles.tiles(genestealers[e]["current location"])[
                                                "connected to"][1]
                                        if (gametiles.tiles(genestealers[e]["current location"])["connected to"][2]):
                                            tracker3 = gametiles.tiles(genestealers[e]["current location"])[
                                                "connected to"][2]
                                        if (gametiles.tiles(genestealers[e]["current location"])["connected to"][3]):
                                            tracker4 = gametiles.tiles(genestealers[e]["current location"])[
                                                "connected to"][3]
                                        ...
                                        while (tracker1 != squad[f]["current_place"] or tracker2 != squad[f]["current_place"] or tracker3 != squad[f]["current_place"] or tracker4 != squad[f]["current_place"]):
                                            tracker1 = gametiles.tiles(
                                                genestealers[e]["current location"]["connected to"][0])
                                            c1 += 1

                                            if (tracker2 != None):
                                                tracker2 = gametiles.tiles(
                                                    genestealers[e]["current location"]["connected to"][1])
                                                c2 += 1

                                            if (tracker3 != None):
                                                tracker3 = gametiles.tiles(
                                                    genestealers[e]["current location"]["connected to"][2])
                                                c3 += 1

                                            if (tracker4 != None):
                                                tracker4 = gametiles.tiles(
                                                    genestealers[e]["current location"]["connected to"][3])
                                                c4 += 1
                                        ...
                                        if (tracker1 == squad[y]["current_place"]):
                                            if (gametiles.tiles(genestealers[e]["current location"]["connected to"][0])["occupied"] != True):
                                                ...
                                                for j in radarblips.RadarBlips.blips:
                                                    if (radarblips.RadarBlips.blips[j]["current location"] == gametiles.tiles(genestealers[e]["current location"])["connected to"][0]):
                                                        break
                                            ...
                                            if (gametiles.tiles(genestealers[e]["current location"]["connected to"][1])["occupied"] != True):
                                                ...
                                                for j in radarblips.RadarBlips.blips:
                                                    if (radarblips.RadarBlips.blips[j]["current location"] == gametiles.tiles(genestealers[e]["current location"])["connected to"][1]):
                                                        break
                                            ...
                                            if (gametiles.tiles(genestealers[e]["current location"]["connected to"][2])["occupied"] != True):
                                                ...
                                                for j in radarblips.RadarBlips.blips:
                                                    if (radarblips.RadarBlips.blips[j]["current location"] == gametiles.tiles(genestealers[e]["current location"])["connected to"][2]):
                                                        break
                                            ...
                                            if (gametiles.tiles(genestealers[e]["current location"]["connected to"][3])["occupied"] != True):
                                                ...
                                                for j in radarblips.RadarBlips.blips:
                                                    if (radarblips.RadarBlips.blips[j]["current location"] == gametiles.tiles(genestealers[e]["current location"])["connected to"][3]):
                                                        break
